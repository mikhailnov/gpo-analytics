...
Для запрета пользователю производить изменение энергосбережения монитора,

в файле `/etc/xdg/powermanagementprofilesrc` блокируется изменение параметров,

символами блокировки строки параметра `[$i]`, и энергосбережение монитора становится
...
Для полного отключения потухания экрана с блокировкой включения,
