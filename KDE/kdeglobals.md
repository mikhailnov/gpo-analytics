...
то будет использоваться цветовая схема `BreezeClassic`

Если в файле `/etc/xdg/kdeglobals` задана несуществующая цветовая схема,

или название указано с ошибкой, то будет использоваться оформление `BreezeClassic`
...
то будет использоваться тема значков `breeze`

Если в файле `/etc/xdg/kdeglobals` задана несуществующая тема значков,

или название указано с ошибкой, то будет использоваться оформление `breeze`
